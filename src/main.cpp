...
uint256 hashGenesisBlock("0x00000c4c8e93791dd9b6166dbf7f3c5759de893e99caff4ff9e1a7235af508dd");
static const unsigned int timeGenesisBlock = 1390564800;
...
/* 8640 blocks/day , 3153600 blocks/year */
	...
	else if (nHeight <= 20 && nHeight > 10)
    {
        nSubsidy = 1 * COIN;
    }
    else if (nHeight <= 30 && nHeight > 20)
    {
        nSubsidy = 0.2 * COIN;
    }
	else if (nHeight <= 40 && nHeight > 30)
    {
        nSubsidy = 0.8 * COIN;
    }
	else if (nHeight <= 50 && nHeight > 40)
    {
        nSubsidy = 0.2 * COIN;
    }
	else if (nHeight <= 60 && nHeight > 50)
    {
        nSubsidy = 0.6 * COIN;
    }
	else if (nHeight <= 70 && nHeight > 60)
    {
        nSubsidy = 0.2 * COIN;
    }
	else if (nHeight <= 80 && nHeight > 70)
    {
        nSubsidy = 0.4 * COIN;
    }
	else if (nHeight >= 80)
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000abede5c1cf80a24d63b6f7ef9af4421cbb86ad66c6f6581cdf5cb7ccf73");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x120c868acf9f65276a88b6dde8080949181cc9a3b7252c61643429f1fdacc656"));
...
unsigned char pchMessageStart[4] = { 0xea, 0xa5, 0x3d, 0xde };
